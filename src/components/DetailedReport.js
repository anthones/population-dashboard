      ...
      <div className="col s12 m6 l4">
        <div className="card">
          <div className="card-image">
            <img
              src={getCountryName(country.original.country)}
              alt={country.original.country}
            />
          </div>
          <div className="card-content">
            ...
            <ul className="collection">
              <li className="collection-item">
                Total population:{" "}
                {country.original.total.toLocaleString("de-DE")}
              </li>
              <li className="collection-item">
                Total male population:{" "}
                {country.original.males.toLocaleString("de-DE")}
              </li>
              <li className="collection-item">
                Total female population:{" "}
                {country.original.females.toLocaleString("de-DE")}
              </li>
            </ul>
          </div>
        </div>
